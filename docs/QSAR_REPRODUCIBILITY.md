...
4. The compact optimized XGBoost surrogate loaded by the original REINVENT4 custom scoring component is included. Other fitted-model binaries are excluded from GitHub; the two Random Forest files are approximately 258 MB and 383 MB.
